...
class CreateAnnonceController extends AbstractController
{
    ...
    public function postForm(Request $request)
    {
        ...
        $response_user = $client_user->request('GET', 'https://3296c880.ngrok.io/utilisateurs/_all_docs?include_docs=true');
        ...
        $response = $client->request('POST', 'https://3296c880.ngrok.io/annonces', [
            "headers" => [
